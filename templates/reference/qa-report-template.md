...
- Load this template via `${GEMINI_EXTENSION_ROOT}/templates/reference/qa-report-template.md`
- Write to the EXACT filename given by Tech Lead in the spawn prompt's `OUTPUT FILENAME` field
