...
<output>
  <template>Load from `${GEMINI_EXTENSION_ROOT}/templates/reference/`: `architecture-template.md`, `design-spec-template.md`, `product-design-summary-template.md`. Exact filenames from Tech Lead.</template>
</output>
