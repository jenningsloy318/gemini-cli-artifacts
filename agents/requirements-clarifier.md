...
2. **Load Template**: You MUST load the document structure from `./templates/reference/requirements-template.md`.
3. **Challenge Framing**: Always question the initial request to find the root need.
4. **5 Whys**: Use iterative questioning for all complex requests.
5. **Acceptance Criteria**: Ensure every requirement has clear, testable criteria.

## Output Format

You MUST produce a document following the structure defined in `templates/reference/requirements-template.md`. Use the XML tags defined there to guide your sectioning and content depth.
