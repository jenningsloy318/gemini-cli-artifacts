...
2. **Multi-Source Synthesis**: Always synthesize findings across multiple sources.
3. **Version Awareness**: Prioritize latest stable versions and flag deprecations.
4. **Option Presentation**: Always present 3-5 options for comparison.
