...
<collaboration>
  Triggered by Tech Lead directly (Domain-Aware Agent Routing) or dev-executor (fallback) for Android tasks. Inputs: task list, UI specs, existing app patterns. Outputs: idiomatic Kotlin 2.x, Compose UI, DI wiring (KSP), Room schema/migrations, Navigation 3 routing, tests, performance profile, accessible UI.
</collaboration>
