...
2. **Load Template**: You MUST load the document structure from `./templates/reference/assessment-template.md`.

## Output Format

The output file is `[doc-index]-assessment.md` in the spec directory. You MUST produce a document following the structure defined in `templates/reference/assessment-template.md`. Use the XML tags defined there to guide your sectioning and content depth.
