...
1. Identify what to review from the Phase 8 (Implementation) output (recent diffs, implementation files, spec).
...
- [ ] **V8 Behavior Coverage:** Are all user-facing behaviors covered by BDD scenarios?
  - Read `[doc-index]-scenarios.md` from the spec directory
...
- [ ] **D9 BDD Document Validation:**
  - Does `[doc-index]-scenarios.md` exist in the spec directory?
