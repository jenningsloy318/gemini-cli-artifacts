...
A comprehensive Tech Lead-driven development workflow for Gemini CLI, using specialized subagents to implement features, fix bugs, and refactor code.
...
8. **Merge**: The Tech Lead merges the verified worktree back to your main branch.
