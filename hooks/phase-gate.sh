...
# Skip tech-lead (it's the orchestrator, not a phase worker)
[[ "$agent_type" == "super-dev:tech-lead" ]] && exit 0
...
# The tech-lead always includes "specification/[spec-index]-[spec-name]" in the prompt
...
# Method 1: Extract from prompt (most reliable — tech-lead always includes spec path)
